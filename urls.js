...
export const userinfoURL = `${localhost}${apiURL}/user-id/`;
...
export const productshopURL = `${localhost}${apivendorURL}/product/list/app`;
...
export const updatevariationURL=`${localhost}${apivendorURL}/variation/update`
//dashboard
