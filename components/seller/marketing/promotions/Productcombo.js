...
import { Pressable, FlatList,TextInput,Text,TouchableHighlight,View,Alert,ImageBackground } from 'react-native';
...
export default connect(mapStateToProps,{updateitem,updatedate})(Productcombo);
