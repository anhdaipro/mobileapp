...
const ListFollowerOffer=()=>{
        ...
        (async()=>{
            ...
            setStats(current=>current.map(item=>{
                if(item.id==1){
                    ...
                    return ({...item,result:obj1.data.number_views,result_last:obj1.data.number_views_last})
                }
                else{
                    return ({...item,result:obj1.data.number_followers,result_last:obj1.data.number_followers_last})
                }
            }))
            }
            catch(err){
    ...
    }, [keyword,choice,end,start,params])
                            ...
                            <div className="card__content">
                                <div data-v-439649ed="" className="header">
                                    ...
                                    <div data-v-439649ed="" className="header-action"> 
                                        <button onClick={()=>navite('/datacenter/marketing/tools/follow-prize')} data-v-439649ed="" type="button" className="button button--link button--normal">
                                            <i className="icon">
                        ...
                        <div data-v-439649ed="" data-v-b811fefc="" data-v-6b00c90e="" className="bundle-list card landing-page-comp _2zaOUn3Zyivml8-HXb4J7v"> 
                            <div className="card__content">
                                <div className="landing-page-header _2mW7Gn-8Q-tvhNnv_9U9mU">
                                    ...
                                    <div data-v-6b00c90e=""> 
                                        <button onClick={()=>navite('/marketing/follow-prize/create')} data-v-6b00c90e="" type="button" className="btn-new button button--primary button--large">
                                            <i className="icon">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th colSpan="1" rowSpan="1" className="">
                                                                <div className="table__cell">
                                                                    <span className="table__cell-label">Lượt sử dụng tối đa</span>
                                                                </div>
                                                            </th>
                                                            <th colSpan="1" rowSpan="1" className="">
                                                                <div className="table__cell">
                                                                    <span className="table__cell-label">Người theo dõi mới</span>
                                                                </div>
                                                            </th>
                                                            <th colSpan="1" rowSpan="1" className="">
                                                                <div className="table__cell">
                                                        ...
                                                        <div className="scrollbar__content">
                                                            <div className="table__body">
                                                                <div className="scrollbar__content">
                                                                    ...
                                                                    <tbody>
                                                                        {follower_offers.map(item=>
                                                                        <tr key={item.id} className="table__row valign-top landing-row">
                                                                                        ...
                                                                                        <div className="info-right">
                                                                                            <div data-v-76c9812a="" className="ellipsis-text-wrapper info-right-item promotion-name">
                                                                                                <div data-v-76c9812a="" className="tooltip popover popover--dark">
                                                                                                    <div className="popover__ref">
                                                                                                        <div data-v-76c9812a="" className="ellipsis-content single">{item.offer_name}</div>
                                                                                                    </div> 
                                                                                                    <div className="popper popover__popper popover__popper--dark tooltip__popper" style={{display: 'none', maxWidth: '280px', wordBreak: 'break-all', overflowWrap: 'break-word'}}>
                                                                                                        <div className="popover__content">{item.offer_name}</div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                            ...
                                                                            <td className="">
                                                                                ...
                                                                                <p data-v-00946860="" className="text-ellipsis">{item.maximum_usage}</p>
                                                                                </div>
                                                                            </td>
                                                                            <td className="">
                                                                                <div className="table__cell">
                                                                                <p data-v-00946860="" className="text-ellipsis">{item.number_follower}</p>
                                                                                </div>
                                                                            </td>
                                                                            <td className="">
                                                                                <div className="table__cell">
                                                                                <div data-v-6b00c90e="" className={`tag tag__information tag--normal ${new Date()>new Date(item.valid_to)?'invalid':new Date()< new Date(item.valid_from)?'default':'success'}`}>{new Date()>new Date(item.valid_to)?'Đã kết thúc':new Date()< new Date(item.valid_from)?'Sắp diễn ra':'Đang diễn ra'}</div> 
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td className="">
                                                                                <div className="table__cell">
                                                                                    ...
                                                                                    <div data-v-6b00c90e="" className="duration">{timepromotion(item.valid_from)} -
                                                                                        <div data-v-6b00c90e="">
                                                                                            <span data-v-6b00c90e="" className="">{timepromotion(item.valid_to)}</span>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div data-v-6b00c90e="" className="action-list-comp _3MyH5U5zfKZqxZyFzTY6wM">
                                                                                        <div className="action-list-item">
                                                                                            <div className="popover popover--light">
                                                                                                <div className="popover__ref">
                                                                                                    <button onClick={()=>setdetail(item)} type="button" className="button button--link button--normal">
                                                                                                        <span>Chi tiết</span>
                                                                                                    </button>
                                                                                                </div> 
                                                                                                <div className="popper popover__popper popover__popper--light with-arrow" style={{display: 'none', maxWidth: '320px'}}>
...
export default ListFollowerOffer