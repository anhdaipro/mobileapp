import { headers,googleLogin,facebookLogin,login,loginotp } from "../../../actions/auths"
...
const Signup=({login, isAuthenticated,googleLogin,facebookLogin,navigation })=>{
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={{marginBottom:24,marginTop:16}}>
        ...
        <View style={{padding:8}}>
            ...
            <Pressable onPress={(e)=>submit(e)} style={[styles.btn,{marginBottom:12,backgroundColor:username && password ?'#ee4d2d':'rgba(0,0,0,.1)'}]}>
...
export default connect(mapStateToProps, { login,googleLogin,facebookLogin })(Signup);
